...
export type AdsCostTrendBucketId = (typeof ADS_COST_TREND_BUCKET_IDS)[number];
...
export type AdsCostTrendBucketDef = {
  ...
  label: string;
  /** Inclusive days-ago from as-of date (0 = as-of day). */
  fromOffset: number;
  toOffset: number;
};
...
export type AdsCostTrendBuckets = Record<AdsCostTrendBucketId, number>;
...
export type AdsCostTrendSortKey = 'brand' | AdsCostTrendBucketId | 'total';
