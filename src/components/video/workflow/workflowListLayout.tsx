...
export const WORKFLOW_LIST_GRID_PRODUCTION =
  'grid grid-cols-[44px_minmax(96px,0.85fr)_minmax(112px,1.15fr)_68px_repeat(5,36px)_minmax(96px,1fr)_84px_64px_88px] gap-2 items-center min-w-[1080px]';

export const WORKFLOW_LIST_GRID_REVIEW =
  'grid grid-cols-[44px_minmax(96px,0.85fr)_minmax(112px,1.15fr)_68px_repeat(5,36px)_minmax(96px,1fr)_84px_56px] gap-2 items-center min-w-[980px]';
