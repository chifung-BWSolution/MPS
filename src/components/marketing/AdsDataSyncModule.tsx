      ...
      <AdsSyncPanel
        ...
        helpText={
          <>
            ...
            啟動時會依廣告 Final URL、Performance Max 資產組 URL、landing page，以及帳戶／Campaign 名稱中的網域自動對應 `webandsystem_list`；未對應網域可到「網站列表」用「同步廣告網域」建立（同時檢查 Google Ads 與 Google Analytics）。
          </>
        }
      />
