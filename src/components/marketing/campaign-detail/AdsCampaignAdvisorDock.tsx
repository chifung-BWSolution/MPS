...
export function AdsCampaignAdvisorDock({
  ...
  return (
    <div
      className={
        open
          ? 'fixed top-[calc(48px+var(--app-banner-h))] right-0 bottom-0 z-40 flex w-[400px] max-w-[100vw] min-w-0 flex-col overflow-hidden border-l border-[rgba(13,26,45,0.08)] bg-white shadow-lg'
          : 'hidden'
      }
    >
