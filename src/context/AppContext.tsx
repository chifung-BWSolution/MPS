...
export const mainMenuItems: MainMenuItem[] = [
  ...
  },
  {
    ...
    subMenus: [
      ...
      { id: 'kol-food', label: '美食 KOL', section: 'KOL' },
      { id: 'kol-beauty', label: '美容 KOL', section: 'KOL' },
      { id: 'kol-shortlist', label: '候選名單', section: 'KOL' },
      { id: 'kol-meeting', label: '預約見面', section: 'KOL' },
      { id: 'kol-cooperated', label: '已合作 KOL', section: 'KOL' },
      { id: 'kol-star', label: '星級藝人', section: 'KOL' },
